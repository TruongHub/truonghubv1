spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> Welcome To Trường Hub <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : Join Trường's Discord to Get the Latest Information <Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
local Window =
    ...
    {
        Title = "Trường Hub",
        SubTitle = "creator Trường Hub | community",
        TabWidth = 160,
...
function InfAbility()
    if _G.SpeedHack then
        if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Texture = "rbxassetid://16115304077"
...
Tabs.Misc:AddButton(
    {
        ...
        Callback = function()
            for i, v in pairs(game:GetObjects("rbxassetid://16115304077")[1]:GetChildren()) do
            ...
            for k, v in pairs(cac) do
                if
                 ...
                 then
                    ...
                    huhu.Image = "rbxassetid://16115304077"
